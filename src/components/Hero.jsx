...
export default function Hero() {
  return (
    <div className="mx-auto max-w-6xl justify-center p-10 md:flex">
      <div>
        <div className="relative md:w-11/12 overflow-hidden">
          <Image
            src={"/background.jpg"}
            ...
            sizes="100vw"
          ></Image>
          <div class="absolute inset-0 flex items-end rounded-lg sm:rounded-2xl bg-gradient-to-t from-gray-900 via-gray-900/40">
            <div className="flex-col items-start gap-3 p-5 ">
              ...
              <button class="m-1 mx-0 rounded-full bg-red-800/50 px-4 py-3 font-bold text-slate-100 hover:bg-red-700">
      ...
      <div className="mt-5 h-max rounded-lg border border-zinc-500/50 p-7 md:mt-0 md:w-1/3 md:border-0">
        <div>
          <p className="text-md sm:text-lg font-semibold dark:text-zinc-300">
            Layar - Sail Through the World of Entertainment
          </p>
          <p className="text-sm sm:text-md text-left font-medium text-zinc-500">
        ...
        <button class="m-3 mx-0 rounded-full bg-red-800  dark:bg-red-800/50 px-4 py-3 font-bold text-slate-100 hover:bg-red-700">
